...
export class KehuApi {
    ...
    public addkehu(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/addkehu', data, res)) {
                    if (showLoadingModal) {
    ...
    public addkehuzhizi(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/addkehuzhizi', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public addworkarr(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/addworkarr', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public deletekehu(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/deletekehu', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public kehudetail(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/kehudetail', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public kehulist(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/kehulist', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public searchcompany(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/searchcompany', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public workdetail(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/workdetail', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public xiugaikehu(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/xiugaikehu', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public xiugaistatus(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/xiugaistatus', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
    ...
    public xiugaizizhi(data, showLoadingModal: boolean = true) {
        ...
        return this.http.post(url, body, options).toPromise()
            .then((res) => {
                if (ApiConfig.DataLoadedHandle('kehu/xiugaizizhi', data, res)) {
                    if (showLoadingModal) {
                        ApiConfig.DimissLoadingModal();
                    }
                    if (res==null) {
